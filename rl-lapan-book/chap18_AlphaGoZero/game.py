...
if __name__ == '__main__':
    ...
    s = INITIAL_STATE; print(render(s))
    s,_ = move(s, 0, 0)  ; print(render(s))
    s,_ = move(s, 1, 1)  ; print(render(s))
    s,_ = move(s, 2, 0)  ; print(render(s))
    s,_ = move(s, 3, 1)  ; print(render(s))
    s,_ = move(s, 4, 0)  ; print(render(s))

    s,_ = move(s, 2, 1)  ; print(render(s))
    s,_ = move(s, 2, 0)  ; print(render(s))
    s,_ = move(s, 2, 1)  ; print(render(s))
    s,_ = move(s, 2, 0)  ; print(render(s))
